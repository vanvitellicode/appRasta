...
import 'package:rms/presentation/POI_screen/controller/poi_controller.dart';
...
class PlaceItinerary extends StatelessWidget {
  final Itinerary itineraryItem;

  const PlaceItinerary({Key? key, required this.itineraryItem}) : super(key: key);
      ...
      child: Container(
        ...
        child: GestureDetector(
          onTap: () {
              ...
              Get.find<POIController>().updatePlaces(itineraryItem.places);
              var controller = Get.find<Home_Controller>();
              controller.updateHome(itineraryItem);
              var mapcontroller = Get.find<MyMapController>();
              mapcontroller.update_Map(itineraryItem);
